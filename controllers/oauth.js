...
export const login = async (req,res) =>{
    ...
    try{
        ...
        const cmuAccount = cmuBasicInfo.cmuitaccount;
        const name = cmuBasicInfo.firstname_EN +" "+ cmuBasicInfo.lastname_EN;
